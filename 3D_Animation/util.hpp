...
std::vector<std::pair<int, int>> getPolygonGridPoints(std::vector<std::pair<int, int>> polygon) { // Returns all grid points that lie within the given polygon. I made this function and posted it here: https://github.com/1ukasz-st/CppSnippets/blob/main/PolygonPoints/main.cpp 
    polar_sort(polygon);
